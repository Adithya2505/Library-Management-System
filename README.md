...
Library Management System with GUI and OOPS, using Python (1st semester Hackathon Project) made using python which uses .csv files to manage a library database by including new students and books into the database and issuing books to students and then even assigning penalty based on book return date.
...
Made with [Aayushman-Codes](https://github.com/Aayushman-Codes/Library-Management-System---Python) and [A-A-coding](https://github.com/A-A-coding)
